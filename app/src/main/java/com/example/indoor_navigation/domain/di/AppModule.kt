package com.example.indoor_navigation.domain.di

import android.app.Application
import androidx.room.Room
import com.example.indoor_navigation.data.data_source.Database
import com.example.indoor_navigation.data.ml.classification.TextAnalyzer
import com.example.indoor_navigation.data.pathfinding.AStarImpl
import com.example.indoor_navigation.data.repository.GraphImpl
import com.example.indoor_navigation.data.repository.RecordsImpl
...
import com.example.indoor_navigation.domain.repository.GraphRepository
...
import com.example.indoor_navigation.domain.use_cases.*

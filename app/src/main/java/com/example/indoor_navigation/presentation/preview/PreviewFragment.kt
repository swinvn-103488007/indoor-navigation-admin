...
import com.example.indoor_navigation.databinding.FragmentPreviewBinding
import com.example.indoor_navigation.domain.tree.TreeNode
import com.example.indoor_navigation.domain.tree.WrongEntryException
import com.example.indoor_navigation.presentation.LabelObject
import com.example.indoor_navigation.presentation.common.helpers.DrawerHelper
import com.example.indoor_navigation.presentation.preview.nodes_adapters.PathAdapter
import com.example.indoor_navigation.presentation.preview.nodes_adapters.TreeAdapter
                        ...
                        is MainUiEvent.InitFailed -> {
                            when (uiEvent.error) {
                                is WrongEntryException -> {
                                    showSnackbar(getString(R.string.wrong_number))
                                }
                                else -> {

...
import com.example.indoor_navigation.databinding.FragmentSearchBinding
import com.example.indoor_navigation.domain.use_cases.GetDestinationDesc
import com.example.indoor_navigation.presentation.search.adapters.EntriesAdapter
import com.example.indoor_navigation.presentation.search.adapters.EntryItem
import com.example.indoor_navigation.presentation.common.helpers.viewHideInput
import com.example.indoor_navigation.presentation.common.helpers.viewRequestInput
import com.example.indoor_navigation.presentation.preview.MainEvent
import com.example.indoor_navigation.presentation.preview.MainShareModel
                ...
                mainModel.searchUiEvents.collectLatest { uiEvent ->
                    when (uiEvent) {
                        ...
                        is SearchUiEvent.SearchInvalid -> {
                            binding.searchLayout.error = resources.getString(R.string.wrong_number)
                            binding.searchInput.viewRequestInput()
                        }
                    }
                }

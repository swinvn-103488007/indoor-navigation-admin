package com.example.indoor_navigation.data.pathfinding
...
import com.example.indoor_navigation.domain.use_cases.SmoothPath
...
class AStarImpl @Inject constructor(
    ...
    //all nodes are set to difficulty 1, you can remove it in theory
